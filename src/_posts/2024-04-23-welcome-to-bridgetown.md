...
date: 2024-04-23 13:20:49 +0300
description: "You’ll find this post in your `_posts` directory. Go ahead and edit it and re-build the site to see your changes. You can rebuild the site in many different ways, but the most common way is to run `bin/bridgetown start`, which launches a web server and auto-regenerates your site when a file is updated."
img: lion.jpg
categories: updates
---

<img class="stylized" src="/images/{{data.img}}"/>
